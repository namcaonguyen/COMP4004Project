Feature: Create a class for a course
	...
	Scenario Outline: An admin creates a class for a course
		...
		When An admin tries to create a class for course code "COMP4004" with "Jean-Pierre Corriveau" <capacity> <prereqs> <precluded>
		Then There exists a class for the "COMP4004" with "Jean-Pierre Corriveau" <capacity> <prereqs> <precluded>
	...
	Scenario: An admin tries to create a class for a course but the course was deleted before the class was created
		...
		When An admin tries to create a class for course code "COMP4004" with "Jean-Pierre Corriveau" 99 "" ""
		Then class is not found in the database
